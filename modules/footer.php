...
<footer>
  <div class="credits sm:block">Site made with:
    ...
    <img class="icon w-12" src="/graphics/simpleIcons/darkBG/html5.svg" alt="HTML5 SVG">
    ...
    <img class="icon w-12" src="/graphics/simpleIcons/darkBG/css.svg" alt="CSS SVG">
  ...
  <div class="social-media hidden lg:block">
    ...
    <a href="https://gitlab.com/Xmetal" aria-label="Xmetalfanx Gitlab Page" target="_blank" rel="noopener">
      <img class="icon w-12" src="/graphics/simpleIcons/gitlab.svg" alt="GitLab SVG">
    ...
    <img class="icon w-12" src="/graphics/simpleIcons/darkBG/github.svg" alt="Github SVG">
    ...
    <img class="icon w-12" src="/graphics/simpleIcons/darkBG/bitbucket.svg" alt="Bitbucket SVG">
    ...
    <img class="icon w-12" src="/graphics/simpleIcons/darkBG/twitter.svg" alt="Twitter SVG"><span class="hiddenAccessLinkText">Find me on Twitter<br/></span></a>

    <a href="https://www.youtube.com/user/Xmetalfanx" aria-label="Xmetalfanx's Youtube Page" target="_blank" rel="noopener">
    <img class="icon w-12" src="/graphics/simpleIcons/darkBG/youtube.svg" alt="Youtube SVG"><span class="hiddenAccessLinkText">Find me on Youtube</span></a>
